...
func (s *Server) decodeAddTagsToNoteRequest(r *http.Request) (
	req *AddTagsRequest,
	close func() error,
	rerr error,
) {
...
func (s *Server) decodeShareNoteRequest(r *http.Request) (
...
func (s *Server) decodeUploadNoteImageRequest(r *http.Request) (
